...
model = AutoModelForCausalLM.from_pretrained("kco4776/soongsil-bert-wellness", return_dict=True)
...
def get_response():
    ...
    try:
        userQuestion = request.args.get('msg')
        print(userQuestion)
    ...
    # Queue - put data
    requests_queue.put(userQuestion)

    # Queue - wait & check
    while 'output' not in userQuestion:
        time.sleep(CHECK_INTERVAL)

    return userQuestion['output']
